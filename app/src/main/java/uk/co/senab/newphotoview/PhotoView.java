...
import uk.co.senab.newphotoview.PhotoViewAttacher.OnMatrixChangedListener;
import uk.co.senab.newphotoview.PhotoViewAttacher.OnPhotoTapListener;
import uk.co.senab.newphotoview.PhotoViewAttacher.OnViewTapListener;
...
public class PhotoView extends ImageView implements IPhotoView {
    ...
    private boolean isLongPicture(Bitmap bitmap) {
        return bitmap.getHeight() >= bitmap.getWidth() * MySimpleDraweeView.DEF_RATIO;
    }
